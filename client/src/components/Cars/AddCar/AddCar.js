		...
		>
			...
			<form id="addCar-form" action="POST" className="addCar-form" onSubmit={onAddCarFormSubmitHandler}>
				...
				<div className="logoContainer">
					...
					<input id="logo" type="text" name="logo" className="formInputStyle" />
				</div>
				<div className="brandHistoryContainer">
					<label htmlFor="rePass">Brand History</label>
					<textarea rows={6} cols={50} id="brandHistory" type="text" name="brandHistory"></textarea>
				</div>
